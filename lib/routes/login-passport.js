module.exports = function(crowi, app) {
  ...
  /**
   * middleware that login with Google OAuth
   * @param {*} req
   * @param {*} res
   * @param {*} next
   */
  ...
  //     clientID: '295982833790-v97kha00uuidsmjj4s2fploig1f569mb.apps.googleusercontent.com',
  //     clientSecret: 'D-Db-sEX3ZRQ1QhlCGIs9IrS',
