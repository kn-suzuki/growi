module.exports = function(crowi, app) {
  ...
  const loginPassportGoogle = function(req, res) {
    console.log("action.loginPassportGoogle")
  ...
  const loginPassportGoogleCallback = function(req, res) {
    passport.authenticate('google', {
      scope: ['https://www.googleapis.com/auth/plus.login']
    });
  };

  // actions.loginPassportGithub = function(req, res) {
  // };

  // actions.loginPassportFacebook = function(req, res) {
  // };

  // actions.loginPassportTwitter = function(req, res) {
  // };
