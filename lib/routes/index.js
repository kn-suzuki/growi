module.exports = function(crowi, app) {
  ...
  app.get('/auth/passport/google'         , loginPassport.loginPassportGoogle);
  app.get('/auth/passport/google/callback', loginPassport.loginPassportGoogleCallback);
  // app.get('/auth/passport/github'  , loginPassport.loginPassportGithub);
  // app.get('/auth/passport/facebook', loginPassport.loginPassportFacebook);
  // app.get('/auth/passport/twitter' , loginPassport.loginPassportTwitter);
